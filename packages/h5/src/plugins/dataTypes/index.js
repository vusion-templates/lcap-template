...
import cookie from '@lcap/template-core/utils/cookie';
import storage from '@lcap/template-core/utils/storage/localStorage';
import { initApplicationConstructor, genSortedTypeKey, genInitData, isInstanceOf } from '@lcap/template-core/plugins/dataTypes/tools';
import { getBasePath } from '@lcap/template-core/utils/encodeUrl';
import authService from '../auth/authService';
import { porcessPorts } from '../router/processService';
import { navigateToUserInfoPage } from '../common/wx';
import { globalUtils,isLooseEqualFn, resolveRequestData } from '@lcap/template-core/plugins/dataTypes/index';
