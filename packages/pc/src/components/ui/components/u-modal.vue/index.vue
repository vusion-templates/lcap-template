...
<transition v-if="(currentVisible || animationVisible)"
    ...
    <div :class="$style.root" :static="this.static" @click="handleClose" :functional-modal="functionalModal">
        <transition
            ...
            <div :class="[$style.dialog, customClass]" ref="dialog"
                ...
                <div :class="$style.head" vusion-slot-name="head" :child-cut-disabled="true" v-if="showHead">
                    <slot name="head">
                        <div v-if="(title || $slots.title) && !isTitleSlotEmpty" vusion-slot-name="title" vusion-slot-name-edit="title" :class="$style.title" :child-cut-disabled="true">
                            <slot name="title">
                                <template>
                                    {{ title }}
                                </template>
                ...
                <div :class="$style.foot" vusion-slot-name="foot" :child-cut-disabled="true" v-if="showFoot && (okButton || cancelButton) && !isFootSlotEmpty">
                    <slot name="foot">
...
<script>
import ULinearLayout from '../u-linear-layout.vue';
